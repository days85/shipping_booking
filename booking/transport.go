...
func MakeHandler(bs Service, logger kitlog.Logger) http.Handler {
	...
	r.Handle("/booking/v1/cargos", bookCargoHandler).Methods(http.MethodPost)
	r.Handle("/booking/v1/cargos", listCargosHandler).Methods(http.MethodGet)
	r.Handle("/booking/v1/cargos/{id}", loadCargoHandler).Methods(http.MethodGet)
	r.Handle("/booking/v1/cargos/{id}/request_routes", requestRoutesHandler).Methods(http.MethodGet)
	r.Handle("/booking/v1/cargos/{id}/assign_to_route", assignToRouteHandler).Methods(http.MethodPost)
	r.Handle("/booking/v1/cargos/{id}/change_destination", changeDestinationHandler).Methods(http.MethodPost)
	r.Handle("/booking/v1/locations", listLocationsHandler).Methods(http.MethodGet)
...
func decodeListCargosRequest(_ context.Context, _ *http.Request) (interface{}, error) {
	return listCargosRequest{}, nil
}

func decodeListLocationsRequest(_ context.Context, _ *http.Request) (interface{}, error) {
